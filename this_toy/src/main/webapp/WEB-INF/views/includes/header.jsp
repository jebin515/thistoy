					...
					<nav class="header_nav">
						<div class="header_menu">
							<a href="/login/login" class="header_login"><i
								...
								class="header_register"><i class='bx-fw bx bxs-user-plus bx-tada-hover'></i>회원가입</a>
						</div>
					</nav>
				</div>
			</c:if>
				...
				<div class="header-full">
					...
					<nav class="header_nav">
						<div class="header_menu">
							...
							<a href="#" class="header_login" onclick="signOut();">
								<i class='bx-fw bx bxs-rocket bx-tada-hover'></i>로그아웃</a>
							<a href="/edit/modify" class="header_register"> <i
				...
				<div class="header-full">
					...
					<nav class="header_nav">
						<div class="header_menu">
							...
							</a> <a href="/admin/admin"> <i class='bx-fw bx bxs-rocket bx-tada-hover'></i>관리자페이지
							</a>
						</div>
					</nav>
				</div>
						...
						<div class="search">
							<form action="/product/list" method="get">
								<input type="text" name="search" placeholder="search" onfocus="placeholder=''"
									onblur='placeholder="search"' class="search_text" required
									oninvalid="this.setCustomValidity('검색어를 입력해주세요')" oninput="setCustomValidity('')">
								<button type="submit">
